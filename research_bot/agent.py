...
Rules:
1. Preserve every sentence that is well-cited and NOT flagged by the fact-checker. Keep their citations exactly and ALWAYS include the citations: [Citation Number](url).
